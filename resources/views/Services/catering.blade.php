...
<head>
    ...
    <title>Catering Services | Tanzania Police School</title>
    ...
    <section class="section menu-section" id="menu">
        <div class="container1">
            ...
            <div x-data="{activeTab: 'breakfast'}">
                ...
                <div class="menu-content" x-show="activeTab === 'breakfast'" style="--i:1">
                ...
                <div class="menu-content" x-show="activeTab === 'lunch'" style="display: none;">
                    <div class="menu-item" style="--i:1">
        ...
        <div class="container1">
            ...
            <div class="contact-form-container1">
                <div class="contact-info">
                    ...
                    <p><strong>Phone:</strong> +255 123 456 789<br>
                    <strong>Email:</strong> catering@tanzaniapolice.edu.tz<br>
                    <strong>Address:</strong> Tanzania Police School, Dar es Salaam, Tanzania</p>
                </div>
