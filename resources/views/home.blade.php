...
<div class="bg-white">
    ...
    <div class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <div x-data="{ tab: 'announcements' }" class="bg-white rounded-xl shadow-lg overflow-hidden">
                <!-- Tab Navigation -->
    ...
    <div class="p-6">
        ...
        <a href="{{ route('news.show', ['news' => 2]) }}" class="text-blue-600 hover:underline">Read more</a>
                        ...
                        <div class="text-center">
                            <a href="{{ route('news.index') }}" class="inline-flex items-center group...">
                              View all news
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-2 transform group-hover:translate-x-1 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                                </svg>
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            <div class="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300">
                                <div class="p-6">
                                    ...
                                    <span lang="it">
  <p class="text-gray-600 mb-4" style="font-style: italic;">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="course-card bg-white rounded-2xl shadow-lg overflow-hidden transform hover:-translate-y-2 transition-all duration-300"
                ...
                <div class="relative h-64 overflow-hidden">
                    <img src="{{ asset('assets/images/Logos/hd-2048x1366-1.jpg') }}"
                         alt="Basic Recruit Courses" 
                         class="course-image w-full h-full object-cover transition-transform duration-300"
                         :class="{ 'scale-110': isHovered }">
                    <div class="absolute inset-0 bg-blue-900 bg-opacity-40 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300">
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 mb-4">
                        Comprehensive entry-level training program designed to transform motivated individuals into professional police officers through rigorous physical and mental preparation.
                    </p>
                    <button 
                        @click="activeModal = 'recruit'"
            ...
            <div class="course-card bg-white rounded-2xl shadow-lg overflow-hidden transform hover:-translate-y-2 transition-all duration-300"
                 ...
                 @mouseleave="isHovered = false">
                <div class="relative h-64 overflow-hidden">
                   <img src="{{ asset('assets/images/Logos/DJI_0466-1066x546.jpg') }}" 
                         alt="Academic Courses" 
                         class="course-image w-full h-full object-cover transition-transform duration-300"
                         :class="{ 'scale-110': isHovered }">
                    <div class="absolute inset-0 bg-green-900 bg-opacity-40 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300">
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 mb-4">
                        Advanced educational programs offering undergraduate degrees and specialized certifications in criminology, forensic science, and law enforcement management.
                    </p>
                    <button 
                        @click="activeModal = 'academic'"
            ...
            <div class="course-card bg-white rounded-2xl shadow-lg overflow-hidden transform hover:-translate-y-2 transition-all duration-300"
                 ...
                 @mouseleave="isHovered = false">
                <div class="relative h-64 overflow-hidden">
                    <img src="{{ asset('assets/images/Logos/IMG-20240918-WA0042-1024x680.jpg') }}" 
                         alt="Promotional Courses" 
                         class="course-image w-full h-full object-cover transition-transform duration-300"
                         :class="{ 'scale-110': isHovered }">
                ...
                <div class="p-6">
                    ...
                    <p class="text-gray-600 mb-4">
                        Specialized leadership and skill enhancement training designed to prepare officers for higher ranks and strategic roles to play within the Tanzania Police Service.
                    </p>
                    <button 
                        @click="activeModal = 'promotion'"
...
<div class="course-card bg-white rounded-2xl shadow-lg overflow-hidden transform hover:-translate-y-2 transition-all duration-300"
     ...
     @mouseleave="isHovered = false">
    <div class="relative h-64 overflow-hidden">
        <img src="{{ asset('assets/images/Logos/IMG-20240305-WA0014-1024x683.jpg') }}" 
             alt="Proficiency Courses" 
             class="course-image w-full h-full object-cover transition-transform duration-300"
             :class="{ 'scale-110': isHovered }">
        <div class="absolute inset-0 bg-orange-900 bg-opacity-40 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity duration-300">
    ...
    <div class="p-6">
        ...
        <p class="text-gray-600 mb-4">
            Specialized training programs focusing on developing specific technical skills, tactical operations, and expertise in areas such as investigation, cybersecurity, and intelligence.
        </p>
        <button 
            @click="activeModal = 'proficiency'"
...
<div class="py-16 bg-white">
    <div class="container mx-auto px-4">
        <div class="text-center mb-12">
            <h2 class="text-4xl font-bold text-gray-800 mb-4">Our Achievements</h2>
            <div class="w-24 h-1 bg-blue-600 mx-auto rounded-full"></div>
            <p class="text-gray-600 mt-4 max-w-2xl mx-auto">Celebrating excellence and milestones that showcase our dedication to service and training.</p>
        </div>
    ...
    slides: [
        {
            image: '{{ asset('assets/images/Logos/achievement1.jpg') }}',
        ...
        {
            image: '{{ asset('assets/images/Logos/achievement2.jpg') }}',
        ...
        {
            image: '{{ asset('assets/images/Logos/achievement3.jpg') }}',
            ...
            description: 'Received international certification for our advanced forensic training program. Our students now benefit from hands-on experience with cutting-edge forensic technology and techniques that meet global standards of excellence.'
                ...
                {
                    image: '{{ asset('assets/images/Logos/achievement4.jpg') }}',
        ...
        class="max-w-5xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="relative">
                <!-- Progress Bar -->
                <div class="absolute top-0 left-0 right-0 h-1 bg-gray-200 z-10">
                ...
                <div class="relative min-h-[400px]">
                    <template x-for="(slide, index) in slides" :key="index">
                        <div x-show="activeSlide === index"
                            ...
                            <!-- Image Side -->
                            <div class="w-full md:w-1/2 h-60 md:h-auto overflow-hidden">
                            ...
                            <div class="w-full md:w-1/2 p-8 flex flex-col justify-center">
                                <div class="mb-3 flex items-center">
                                    ...
                                    <span class="text-sm text-gray-500 ml-2">Achievement <span x-text="index + 1"></span> of <span x-text="slides.length"></span></span>
                                </div>
                                <h3 class="text-2xl font-bold text-gray-800 mb-4" x-text="slide.title"></h3>
                                <p class="text-gray-600 leading-relaxed" x-text="slide.description"></p>
                            </div>
                        </div>
                    </template>
                </div>
                ...
                <button @click="activeSlide = (activeSlide - 1 + slides.length) % slides.length"
                    class="absolute left-4 top-1/2 -translate-y-1/2 bg-white/80 hover:bg-white rounded-full p-2 shadow-lg hover:shadow-xl transition-all duration-300 focus:outline-none">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                    </svg>
                </button>
                <button @click="activeSlide = (activeSlide + 1) % slides.length"
                    class="absolute right-4 top-1/2 -translate-y-1/2 bg-white/80 hover:bg-white rounded-full p-2 shadow-lg hover:shadow-xl transition-all duration-300 focus:outline-none">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                </button>
            ...
            <!-- Indicators -->
            <div class="bg-gray-50 px-8 py-4 flex justify-center space-x-2">
        ...
        <div class="mt-10 text-center">
            <a href="{{ route('about.achievements') }}" class="inline-flex items-center group px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors duration-300 shadow-md">
